...
class Media(object):
    ...
    """
    openapi_types = {
        'attributes': 'map(AnyType)',
        'codec': 'character',
        'created_by': 'integer',
        'created_datetime': 'character',
        'file': 'character',
        'fps': 'integer',
        'height': 'integer',
        'id': 'integer',
        'last_edit_end': 'character',
        'last_edit_start': 'character',
        'md5': 'character',
        'media_files': 'MediaFiles',
        'meta': 'integer',
        'modified_by': 'integer',
        'modified_datetime': 'character',
        'name': 'character',
        'num_frames': 'integer',
        'original': 'character',
        'project': 'integer',
        'segment_info': 'character',
        'thumbnail': 'character',
        'thumbnail_gif': 'character',
        'width': 'integer'
    }
