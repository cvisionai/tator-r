...
class LocalizationType(object):
    ...
    def __init__(self, attribute_types=None, colorMap=None, description=None, dtype=None, id=None, line_width=None, media=None, name=None, project=None, visible=TRUE, local_vars_configuration=None):  # noqa: E501
    ...
    def colorMap(self):
        ...
        :return: The colorMap of this LocalizationType. 
        :rtype: ColorMap
        """
    ...
    def colorMap(self, colorMap):
        ...
        :param colorMap: The colorMap of this LocalizationType.
        :type: ColorMap
        """
