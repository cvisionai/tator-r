...
class MediaFiles(object):
    ...
    """
    openapi_types = {
        'archival': 'array[VideoDefinition]',
        'audio': 'array[AudioDefinition]',
        'streaming': 'array[VideoDefinition]'
    }
