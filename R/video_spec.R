...
class VideoSpec(object):
    ...
    openapi_types = {
        ...
        'name': 'character',
        'num_frames': 'integer',
        'progressName': 'character',
        'section': 'character',
        'thumbnail_gif_url': 'character',
    ...
    def __init__(self, codec=None, fps=None, gid=None, height=None, md5=None, media_files=None, name=None, num_frames=None, progressName=None, section=None, thumbnail_gif_url=None, thumbnail_url=None, type=None, uid=None, width=None, local_vars_configuration=None):  # noqa: E501
    ...
    def progressName(self):
        ...
        :return: The progressName of this VideoSpec. 
        :rtype: character
        """
        return self._progressName

    @progressName.setter
    def progressName(self, progressName):
        """
        Name to use for progress update.

        :param progressName: The progressName of this VideoSpec.
        :type: character
        """

        self._progressName = progressName
